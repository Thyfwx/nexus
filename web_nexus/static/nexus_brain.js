...
// AUTO-RELOAD ON NEW BUILD — restored 2026-05-09 (Xavier wants it kept).
// Polls /api/build on focus + every 30s. If the build stamp changed since
// page load, shows a click-to-reload banner. No emojis. Subtle styling.
(function _autoBuildWatch(){
    ...
    function _showBanner(newBuild){
        ...
        bar.style.cssText = 'position:fixed; top:0; left:0; right:0; z-index:99999; background:rgba(0,30,30,0.94); color:#0ff; border-bottom:1px solid rgba(0,255,255,0.35); padding:8px 14px; font:600 0.74rem "Fira Code",monospace; text-align:center; letter-spacing:1px; cursor:pointer; backdrop-filter:blur(4px);';
