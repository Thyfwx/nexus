...
const PACIFIC_HUB = 'https://nexus-evil-proxy.REMOVED.workers.dev';
...
function renderAuthSection() {
    ...
    if (nexusUser && nexusUser.name) {
        ...
        const avatarHtml = nexusUser.picture 
            ? `<img src="${nexusUser.picture}" class="auth-avatar" style="width:32px !important; height:32px !important; border-radius:50%; border:1px solid var(--accent); flex-shrink:0;" alt="User">`
