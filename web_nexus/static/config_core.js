// ⚙️ NEXUS CONFIGURATION CORE v5.3.8
window.HISTORY_KEYS = { nexus: 'nh_nexus', unfiltered: 'nh_unfiltered', coder: 'nh_coder', sage: 'nh_sage', education: 'nh_education', education_coder: 'nh_education_coder' };
